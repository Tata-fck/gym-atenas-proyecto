...
<body>
    <main>
        ...
        <link rel="stylesheet" href="css/ubicacion.css?v=<?php echo $version; ?>">
         ...
         <div class="contenedor-1">
            ...
            <div class="seccion-texto-1">
                <a href="https://share.google/SJ1oEwJlseGkQa2on" target="_blank">
                    <p><span></span>Calle Gitana 49 B, La Nopalera, Tláhuac, 13220 Ciudad de México, CDMX.</p>
                </a>
            </div>
